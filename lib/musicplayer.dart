...
class BookL extends StatefulWidget {
  final int index;
  final String section;

  BookL({required this.index, required this.section});

  @override
  State<BookL> createState() => _BookLState();
}

class _BookLState extends State<BookL> {
                                    ...
                                    onPressed: () {
                                      if (!playing) {
                                        setState(() {
                                          ...
                                          playing = true;
                                          player.play(AssetSource("songs/s.flac"));
                                        });
                                      } else {
                                        setState(() {
